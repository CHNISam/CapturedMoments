    ...
    <section id="settings">
      ...
      <div class="card settings-tree">
        <ul class="tree-root">
          <!-- 视觉／界面设置 -->
          <li>
            <div class="tree-node" @click="toggleSection('visual')">
              ...
              <svg class="icon" viewBox="0 0 24 24">
                <path v-if="activeSection === 'visual'"   d="M9 6l6 6-6 6"/>
          ...
          <!-- 个人资料 -->
          <li>
            <div class="tree-node" @click="toggleSection('profile')">
              <svg class="tree-icon" viewBox="0 0 24 24" stroke="currentColor" fill="none" stroke-width="2">
              ...
              <svg class="icon" viewBox="0 0 24 24">
                <path v-if="activeSection === 'profile'" d="M9 6l6 6-6 6"/>
                <path v-else                       d="M6 9l6 6 6-6"/>
              </svg>
            </div>
            <transition name="slide-fade">
          ...
          <!-- 发布与上传 -->
          <li>
            <div class="tree-node" @click="toggleSection('publish')">
              ...
              <svg class="icon" viewBox="0 0 24 24">
                <path v-if="activeSection === 'publish'" d="M9 6l6 6-6 6"/>
                <path v-else                      d="M6 9l6 6 6-6"/>
              </svg>
            </div>
            <transition name="slide-fade">
          ...
          <!-- 管理员 -->
          <li v-if="isAdmin">
            <div class="tree-node" @click="toggleSection('admin')">
              <svg class="tree-icon" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 7a2 2 0 012 2m4 0a6 6 0 01-7.743 5.743L11 17H9v2H7v2H4a1 1 0 01-1-1v-2.586a1 1 0 01.293-.707l5.964-5.964A6 6 0 1121 9z"/>
              </svg>
              <span class="tree-label">账号管理（Admin）</span>
              <svg class="icon" viewBox="0 0 24 24">
                <path v-if="activeSection === 'admin'" d="M9 6l6 6-6 6"/>
                <path v-else                     d="M6 9l6 6 6-6"/>
              </svg>
            </div>
            <transition name="slide-fade">
              <ul v-show="activeSection === 'admin'" class="settings-group">
